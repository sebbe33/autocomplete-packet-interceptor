...
public class SuggestionsCollector 
{
    ...
    {
		SuggestionsCollector app = new SuggestionsCollector();
		app.gatherSuggestions("abcdefghijklmnopqrstuvwxyz", AmazonUKProperties.INSTANCE, 4);
    }
